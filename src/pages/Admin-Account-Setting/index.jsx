...
export default function AdminAccountSettings() {
  ...
  return (
    <div className="w-full  bg-white  rounded-b-lg shadow-md p-6">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-400"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <input
              ...
              className="w-1/2 px-3 py-2 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-400"
            />
          </div>
        </div>
      </div>
            ...
            <div>
              ...
              <div className="relative">
                <button
                  ...
                  className="w-full px-3 py-2 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded text-left focus:outline-none focus:ring-1 focus:ring-blue-400 flex items-center justify-between"
                >
