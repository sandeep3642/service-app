                  ...
                  <div className="flex items-start md:items-center space-x-3 w-full md:w-auto">
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-xs text-gray-500 flex items-center flex-wrap">
                        ...
                        <span
                          className={`ml-2 text-xs font-medium ${getStatusBadge(
                            status
                          )}`}
                        >
                          {status}
                    ...
                    {status === "pending" && (
                      <>
                        <button
                          ...
                          className="bg-[#03A416] text-white text-xs px-4 py-1 rounded"
                        >
                          Approve
                        </button>
                        <button
                          onClick={() => setShowRejectModal(id)}
                          className="border border-[#FF0606] text-[#FF0606] text-xs px-4 py-1 rounded"
                        >
                          Reject
                        </button>
                      </>
