        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 p-6 flex flex-col items-center justify-center">
                        ...
                        <p className="text-sm text-gray-600 text-center">"Excellent Service and Quick Response"</p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="bg-white rounded-lg border border-gray-200 p-6 text-center">
                            ...
                            <span className="text-3xl font-bold text-gray-900">1.5 hrs</span>
                        </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200">
                ...
                <div className="p-6 border-b border-gray-200">
                    <div className="flex justify-between items-center">
                        <div className="flex items-center space-x-4">
                            <h3 className="text-lg font-semibold text-gray-900">High ratings</h3>
                        </div>
                        <div className="relative">
                            <input
                                type="text"
                        ...
                        <tbody>
                            {filteredReviews.map((review, index) => (
                                <tr key={index} className="border-b border-gray-100 hover:bg-gray-50">
                                    ...
                                    <td className="py-4 px-6 text-sm text-gray-900">{review.message}</td>
